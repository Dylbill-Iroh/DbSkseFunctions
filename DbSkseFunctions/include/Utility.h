...
bool FormNameMatches(RE::TESForm * akForm, std::string & sFormName, bool checkIdentity = true);

bool FormNameContains(RE::TESForm * akForm, std::string & sFormName, bool checkIdentity = true);
